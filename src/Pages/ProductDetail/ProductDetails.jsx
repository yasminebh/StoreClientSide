...
import ImgSwiperComponent from '../../components/Swiper/ImgSwiperComponent'
          ...
          <div className="col-lg-5 pb-5">
            ...
            >
              <div className="carousel-inner border">
                {/*  {data?.gallery?.map((i,index) => {return  <ImgSwiperComponent images={i?.gallery} key={index}/> } */}
                <ImgSwiperComponent images={data?.gallery} />
              </div>
              <a
